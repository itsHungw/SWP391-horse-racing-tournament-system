-- Baseline schema generated from the JPA entities and hand-checked.
-- Single source of truth for the database schema; see
...
--
-- Dialect: PostgreSQL. T-SQL -> Postgres type mapping applied across all migrations:
--   datetime2(7)        -> timestamp(6)                       (LocalDateTime)
--   bigint identity     -> bigint generated by default as identity
--   nvarchar(max)/varchar(max) -> text
--   bit                 -> boolean
--   numeric(p,s)        -> numeric(p,s)                       (unchanged)
--   "unique nonclustered index ... where" -> partial unique index (same WHERE syntax)

create table auth_sessions (created_at timestamp(6) not null, expires_at timestamp(6) not null, id bigint generated by default as identity not null, last_used_at timestamp(6), replaced_by_session_id bigint, revoked_at timestamp(6), user_id bigint not null, ip_address varchar(100), user_agent varchar(500), refresh_token_hash varchar(255) not null, primary key (id));
create table blogs (author_id bigint not null, created_at timestamp(6) not null, id bigint generated by default as identity not null, updated_at timestamp(6), status varchar(50) not null check ((status in ('DRAFT','PUBLISHED'))), summary varchar(500), content text not null, slug varchar(255) not null, thumbnail varchar(255), title varchar(255) not null, primary key (id));
create table email_verification_tokens (created_at timestamp(6) not null, expires_at timestamp(6) not null, id bigint generated by default as identity not null, used_at timestamp(6), user_id bigint not null, token_hash varchar(255) not null, primary key (id));
create table horse_documents (expiry_date date not null, issue_date date not null, created_at timestamp(6) not null, horse_id bigint not null, id bigint generated by default as identity not null, uploaded_by bigint not null, document_type varchar(50) not null, reference_number varchar(100) not null, issuer varchar(150) not null, file_url varchar(500) not null, notes varchar(255), primary key (id));
create table horse_owner_profiles (experience_years int not null, approved_at timestamp(6), approved_by bigint, created_at timestamp(6) not null, id bigint generated by default as identity not null, updated_at timestamp(6), user_id bigint not null, contact_phone varchar(30), status varchar(30) not null, license_number varchar(100), contact_email varchar(150), organization_name varchar(150), owner_name varchar(150), stable_name varchar(150), evidence_url varchar(500), logo_url varchar(500), bio varchar(255), contact_address varchar(255), description varchar(255), rejection_reason varchar(255), primary key (id));
create table horses (date_of_birth date, height_cm int, weight_kg int, approved_at timestamp(6), approved_by bigint, created_at timestamp(6) not null, deleted_at timestamp(6), id bigint generated by default as identity not null, owner_id bigint not null, updated_at timestamp(6), gender varchar(20) not null, status varchar(30) not null, color varchar(50), health_status varchar(50), breed varchar(100), registration_code varchar(100), name varchar(150) not null, evidence_url varchar(500), image_url varchar(500), description varchar(255), medical_note varchar(255), rejection_reason varchar(255), primary key (id));
create table jockey_invitations (accepted_at timestamp(6), created_at timestamp(6) not null, horse_id bigint not null, id bigint generated by default as identity not null, jockey_application_id bigint not null, jockey_id bigint not null, owner_id bigint not null, read_at timestamp(6), rejected_at timestamp(6), tournament_id bigint not null, tournament_registration_id bigint not null, updated_at timestamp(6), status varchar(30) not null, agreement_url varchar(500), message varchar(500), rejection_reason varchar(500), agreement_file_name varchar(255), primary key (id));
create table jockey_tournament_applications (created_at timestamp(6) not null, id bigint generated by default as identity not null, jockey_id bigint not null, reviewed_at timestamp(6), reviewed_by bigint, tournament_id bigint not null, updated_at timestamp(6), withdrawn_at timestamp(6), status varchar(30) not null, message varchar(500), rejection_reason varchar(500), primary key (id));
create table password_reset_tokens (created_at timestamp(6) not null, expires_at timestamp(6) not null, id bigint generated by default as identity not null, used_at timestamp(6), user_id bigint not null, token_hash varchar(255) not null, primary key (id));
create table point_settings (setting_value int not null, updated_at timestamp(6), updated_by bigint, setting_key varchar(80) not null check ((setting_key in ('FIRST_LOGIN_BONUS','BLOG_REWARD_POINTS','DAILY_BLOG_REWARD_LIMIT','PREDICTION_WINNER_ENTRY_COST','PREDICTION_TOP3_ENTRY_COST','PREDICTION_WINNER_REWARD','PREDICTION_TOP3_EXACT_REWARD','PREDICTION_TOP3_ANY_ORDER_REWARD'))), description varchar(255), primary key (setting_key));
create table point_transactions (amount int not null, created_at timestamp(6) not null, id bigint generated by default as identity not null, reference_id bigint, user_id bigint not null, reference_type varchar(50), transaction_type varchar(50) not null check ((transaction_type in ('FIRST_LOGIN_BONUS','PREDICTION_ENTRY','PREDICTION_REWARD','BLOG_REWARD','RACE_CANCEL_REFUND','ADMIN_ADJUSTMENT'))), description varchar(500), primary key (id));
create table pre_race_checks (equipment_ok boolean not null, health_ok boolean not null, horse_identity_ok boolean not null, jockey_identity_ok boolean not null, weight_ok boolean not null, checked_at timestamp(6) not null, created_at timestamp(6) not null, id bigint generated by default as identity not null, participant_id bigint not null, race_id bigint not null, referee_id bigint not null, result varchar(30) not null, note varchar(255), primary key (id));
create table prediction_settlement_jobs (failed_count int not null, processed_count int not null, retry_count int not null, rewarded_count int not null, completed_at timestamp(6), created_at timestamp(6) not null, id bigint generated by default as identity not null, race_id bigint not null, started_at timestamp(6), updated_at timestamp(6), status varchar(30) not null, error_message varchar(255), primary key (id));
create table race_participants (lane_number int, start_number int, weight_carried_kg numeric(5,2), created_at timestamp(6) not null, horse_id bigint not null, id bigint generated by default as identity not null, invitation_id bigint, jockey_id bigint, owner_id bigint not null, race_id bigint not null, updated_at timestamp(6), check_status varchar(30) not null, confirmation_status varchar(30) not null, status varchar(30) not null, check_note varchar(255), primary key (id));
create table race_predictions (entry_cost_points int not null, reward_points int not null, created_at timestamp(6) not null, evaluated_at timestamp(6), id bigint generated by default as identity not null, locked_at timestamp(6), predicted_second_id bigint, predicted_third_id bigint, predicted_winner_id bigint not null, race_id bigint not null, spectator_id bigint not null, updated_at timestamp(6), prediction_type varchar(30) not null, status varchar(30) not null, primary key (id));
create table race_results (finish_time_seconds numeric(10,3), penalty_seconds numeric(10,3) not null, points int not null, position int, prize_points int not null, raw_finish_time_seconds numeric(10,3), confirmed_at timestamp(6), confirmed_by bigint, created_at timestamp(6) not null, id bigint generated by default as identity not null, participant_id bigint not null, published_at timestamp(6), race_id bigint not null, submitted_at timestamp(6) not null, submitted_by bigint not null, updated_at timestamp(6), result_status varchar(30) not null, status varchar(30) not null, note varchar(255), primary key (id));
create table races (distance_meter int not null, max_participants int not null, min_participants int not null, race_number int, created_at timestamp(6) not null, created_by bigint not null, deleted_at timestamp(6), id bigint generated by default as identity not null, race_at timestamp(6) not null, referee_id bigint, tournament_id bigint not null, updated_at timestamp(6), status varchar(40) not null, track_condition varchar(50), code varchar(100) not null, round_name varchar(100), track_name varchar(150), name varchar(200) not null, note varchar(255), primary key (id));
create table referee_profiles (experience_years int not null, approved_at timestamp(6), approved_by bigint, created_at timestamp(6) not null, id bigint generated by default as identity not null, updated_at timestamp(6), user_id bigint not null, status varchar(30) not null check ((status in ('PENDING','ACTIVE','REJECTED','SUSPENDED','INACTIVE'))), license_number varchar(100), evidence_url varchar(500), certification varchar(255), rejection_reason varchar(255), bio text, primary key (id));
create table referee_reports (confirmed_at timestamp(6), confirmed_by bigint, created_at timestamp(6) not null, id bigint generated by default as identity not null, race_id bigint not null, referee_id bigint not null, submitted_at timestamp(6), updated_at timestamp(6), status varchar(30) not null, title varchar(200), ai_summary varchar(255), rejection_reason varchar(255), summary varchar(255) not null, primary key (id));
create table role_requests (created_at timestamp(6) not null, cv_reviewed_at timestamp(6), cv_reviewed_by bigint, id bigint generated by default as identity not null, reviewed_at timestamp(6), reviewed_by bigint, updated_at timestamp(6), user_id bigint not null, cv_review_status varchar(30) not null, status varchar(30) not null, requested_role varchar(50) not null, resume_url varchar(500), admin_note text, cv_review_note text, reason text, primary key (id));
create table roles (id bigint generated by default as identity not null, name varchar(50) not null, description varchar(255), primary key (id));
create table stored_files (private_file boolean not null, created_at timestamp(6) not null, file_size bigint not null, id bigint generated by default as identity not null, uploaded_by bigint not null, category varchar(50) not null, content_type varchar(100) not null, filename varchar(120) not null, object_key varchar(500) not null, original_filename varchar(255) not null, primary key (id));
create table tournament_participants (points int not null, created_at timestamp(6) not null, horse_id bigint not null, id bigint generated by default as identity not null, jockey_id bigint not null, jockey_invitation_id bigint, owner_id bigint not null, tournament_id bigint not null, tournament_registration_id bigint not null, updated_at timestamp(6), status varchar(30) not null, primary key (id));
create table tournament_registrations (created_at timestamp(6) not null, horse_id bigint not null, id bigint generated by default as identity not null, owner_id bigint not null, reviewed_at timestamp(6), reviewed_by bigint, tournament_id bigint not null, updated_at timestamp(6), withdrawn_at timestamp(6), status varchar(30) not null, note varchar(255), rejection_reason varchar(255), primary key (id));
create table tournaments (end_date date not null, max_horses int, max_horses_per_owner int not null, start_date date not null, created_at timestamp(6) not null, created_by bigint not null, deleted_at timestamp(6), id bigint generated by default as identity not null, registration_end_at timestamp(6) not null, registration_start_at timestamp(6) not null, updated_at timestamp(6), status varchar(40) not null, code varchar(100) not null, name varchar(200) not null, description varchar(255), location varchar(255) not null, primary key (id));
create table user_blog_rewards (points_earned int not null, reading_seconds int not null, scroll_percent int not null, blog_id bigint not null, earned_at timestamp(6) not null, id bigint generated by default as identity not null, user_id bigint not null, reward_status varchar(30) not null, primary key (id));
create table user_daily_point_limits (point_date date not null, points_earned_from_blog int not null, points_earned_total int not null, created_at timestamp(6) not null, id bigint generated by default as identity not null, updated_at timestamp(6), user_id bigint not null, primary key (id));
create table user_point_accounts (point_balance int not null, updated_at timestamp(6) not null, user_id bigint not null, primary key (user_id));
create table user_role_history (changed_at timestamp(6) not null, changed_by bigint, id bigint generated by default as identity not null, user_role_id bigint not null, new_status varchar(30) not null, old_status varchar(30), reason text, primary key (id));
create table user_roles (assigned_at timestamp(6) not null, assigned_by bigint, id bigint generated by default as identity not null, removed_at timestamp(6), removed_by bigint, role_id bigint not null, user_id bigint not null, status varchar(30) not null, primary key (id));
create table users (age_verified boolean not null, date_of_birth date, email_verified boolean not null, phone_verified boolean not null, profile_completed boolean not null, created_at timestamp(6) not null, deleted_at timestamp(6), id bigint generated by default as identity not null, last_login_at timestamp(6), password_changed_at timestamp(6), updated_at timestamp(6), gender varchar(20), phone varchar(30), status varchar(30) not null, email varchar(150) not null, full_name varchar(150) not null, avatar_url varchar(500), address varchar(255), password_hash varchar(255) not null, primary key (id));
create table violations (created_at timestamp(6) not null, id bigint generated by default as identity not null, occurred_at timestamp(6), participant_id bigint, race_id bigint not null, reported_by bigint not null, updated_at timestamp(6), severity varchar(30), violation_type varchar(100), penalty varchar(150), description varchar(255) not null, primary key (id));
...
create unique index UKi19gkudpajmph5a91a3f0f304 on horses (registration_code) where registration_code is not null;
