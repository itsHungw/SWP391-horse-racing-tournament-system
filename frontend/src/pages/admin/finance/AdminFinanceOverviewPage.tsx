  ...
  return (
    <AdminLayout>
      <section className="space-y-6" aria-labelledby="finance-title">
        ...
        {summary.loading ? <div aria-busy="true" aria-label="Loading finance metrics" className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">{dayOptions.map((item) => <div className="h-40 animate-pulse bg-slate-200 motion-reduce:animate-none" key={item} />)}<div className="h-40 animate-pulse bg-slate-200 motion-reduce:animate-none" /><div className="h-40 animate-pulse bg-slate-200 motion-reduce:animate-none" /></div> : null}
