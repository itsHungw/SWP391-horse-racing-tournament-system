...
export function RefereeProfileDashboardPage({ now }: RefereeProfileDashboardPageProps) {
  ...
  if (loading) {
    return (
      <section className="max-w-6xl mx-auto px-4 py-8 space-y-5" aria-label="Loading referee credential center">
  ...
  if (error) {
    return (
      <div className="max-w-6xl mx-auto px-4 py-8 rounded-xl border border-rose-200 bg-rose-50 p-6" role="alert">
  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-8 space-y-8" aria-labelledby="referee-profile-title">
      ...
      <div className="flex border-b border-slate-200">
        <button
          ...
          className={`pb-4 px-6 text-sm font-black border-b-2 transition-colors focus:outline-none ${
            activeTab === "dashboard"
      ...
      {activeTab === "dashboard" && (
        <>
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1.05fr)_minmax(420px,0.95fr)]">
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm border-t-4 border-t-[#007a68]">
            ...
            <article className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm border-t-4 border-t-[#007a68]">
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="text-[11px] font-black uppercase tracking-wider text-slate-500">License number</p>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="text-[11px] font-black uppercase tracking-wider text-slate-500">Certification</p>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="text-[11px] font-black uppercase tracking-wider text-slate-500">Experience</p>
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="text-[11px] font-black uppercase tracking-wider text-slate-500">Approved date</p>
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
            <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm border-t-4 border-t-[#007a68]" aria-labelledby="credential-readiness-title">
            ...
            <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm border-t-4 border-t-[#007a68]" aria-labelledby="referee-activity-title">
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                {[
                  { label: "Race cards", value: races.length, icon: ShieldCheck, colorClass: "text-[#007a68]", bgClass: "bg-emerald-50", helper: "Official race cards assigned" },
                  { label: "Active assignments", value: activeAssignments, icon: ClipboardCheck, colorClass: "text-blue-700", bgClass: "bg-blue-50", helper: "Still waiting for operation or result" },
                  { label: "Completed packages", value: completedResults, icon: BadgeCheck, colorClass: "text-indigo-700", bgClass: "bg-indigo-50", helper: "Confirmed result packages" },
                  { label: "Pre-race queue", value: preRaceQueue, icon: UserRound, colorClass: "text-amber-700", bgClass: "bg-amber-50", helper: "Checks, ready, or scheduled cards" },
                ].map(({ label, value, icon: Icon, colorClass, bgClass, helper }) => (
                  <article key={label} className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                    <div className={`flex h-10 w-10 items-center justify-center rounded-full ${bgClass} ${colorClass} mb-3`}>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm border-t-4 border-t-[#007a68]" aria-labelledby="referee-bio-title">
      ...
      {activeTab === "edit" && (
        <section
          ...
          className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm border-t-4 border-t-[#007a68]"
