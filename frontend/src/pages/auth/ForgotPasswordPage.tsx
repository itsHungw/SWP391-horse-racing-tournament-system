...
export function ForgotPasswordPage() {
  useDocumentTitle("Forgot Password | EquinePro Elite");
        ...
        >
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-[1fr_auto]">
                    ...
                    />
                    <button
                      className="min-h-11 bg-nyraGreen px-4 py-3 text-xs font-bold uppercase tracking-[0.16em] text-white shadow-lg transition-colors hover:bg-nyraLightGreen focus:outline-none focus-visible:ring-2 focus-visible:ring-nyraGold disabled:opacity-60"
            ...
            {step === "success" && (
              ...
              >
                <Link
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-nyraGreen px-6 py-3 text-xs font-bold uppercase tracking-widest text-white shadow-md shadow-nyraGreen/30 transition-all duration-200 hover:bg-nyraLightGreen hover:shadow-nyraGreen/40 hover:scale-[1.03] active:scale-95"
                  to="/login"
                >
